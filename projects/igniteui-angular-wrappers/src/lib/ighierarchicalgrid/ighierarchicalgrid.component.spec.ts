...
describe('Infragistics Angular HierarchicalGrid', () => {
    ...
    it('should initialize correctly', (done) => {
        const template = '<div><ig-hierarchical-grid [(widgetId)]="gridID" [(options)]="opts"></ig-hierarchical-grid></div>';
    ...
    it('should reflect changes when a record in the data changes', (done) => {
        const template = '<div><ig-hierarchical-grid [(widgetId)]="gridID" [options]="opts" [dataSource]="data"></ig-hierarchical-grid></div>';
        TestBed.overrideComponent(TestComponent, {
            set: {
                template
            }
    ...
    it('should reflect changes when records in the grid are updated', (done) => {
        ...
        TestBed.compileComponents().then(() => {
            ...
            setTimeout(() => {
                fixture.detectChanges();
                const fName = fixture.componentInstance.data[0].Name;
    ...
    it('should reflect changes when child records are changed', (done) => {
        ...
        TestBed.compileComponents().then(() => {
            ...
            fixture.detectChanges();
            // expand first record
            const row = $('#grid1').igGrid('rowAt', 0);
    ...
    it('should reflect changes when a value in the child grid changes', (done) => {
        const template = '<div><ig-hierarchical-grid [(widgetId)]="gridID" [(options)]="opts" [dataSource]="data" #hgrid></ig-hierarchical-grid></div>';
        TestBed.overrideComponent(TestComponent, {
            set: {
                template
            }
    ...
    it('should initialize correctly when datasource is remote', (done) => {
        ...
        const template = '<div><ig-hierarchical-grid [(widgetId)]="gridID2" [(options)]="opts2"></ig-hierarchical-grid></div>';
        TestBed.overrideComponent(TestComponent, {
            set: {
                template
            }
    ...
    it('should detect changes when original data source is changed but the data source length is the same.', (done) => {
        const template = '<ig-hierarchical-grid [(widgetId)]="gridID" [(options)]="optsNew" [dataSource]="singleRecData"></ig-hierarchical-grid>';
        TestBed.overrideComponent(TestComponent, {
            set: {
                template
            }
    ...
    it('should fill the featuresList and allow accessing their methods', (done) => {
        const template = '<div><ig-hierarchical-grid [(widgetId)]="gridID" [(options)]="opts" [dataSource]="data"></ig-hierarchical-grid></div>';
        TestBed.overrideComponent(TestComponent, {
            set: {
                template
        ...
        TestBed.compileComponents().then(() => {
            const fixture = TestBed.createComponent(TestComponent);
            fixture.detectChanges();
            fixture.componentInstance.viewChild.featuresList.updating.deleteRow(1);
            setTimeout(() => {
                fixture.detectChanges();
                expect(fixture.componentInstance.data.length).toBe(2);
                done();
