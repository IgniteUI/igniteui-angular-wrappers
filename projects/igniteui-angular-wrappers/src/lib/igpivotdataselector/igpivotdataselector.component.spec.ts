...
describe('Infragistics Angular PivotDataSelector', () => {
    ...
    it('should initialize correctly', (done) => {
        const template = '<div><ig-pivot-data-selector [(widgetId)]="selId" [options]="optsGrid"></ig-pivot-data-selector></div>';
    ...
    it('should allow initializing data source as a top level option', (done) => {
        const template = '<div><ig-pivot-data-selector  [widgetId]="\'pds\'" [(dataSource)]="data"></ig-pivot-data-selector></div>';
        TestBed.overrideComponent(TestComponent, {
            set: {
                template
            }
...
class TestComponent {
    ...
    @ViewChild(Infragistics.IgPivotDataSelectorComponent, { static: true }) public viewChild: Infragistics.IgPivotDataSelectorComponent;
