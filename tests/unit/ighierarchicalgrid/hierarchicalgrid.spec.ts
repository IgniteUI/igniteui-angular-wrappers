...
export function main() {
    describe('Infragistics Angular2 HierarchicalGrid', function () {
        ...
        it('should initialize correctly when datasource is remote', (done) => {
            ...
            var template = '<div><ig-hierarchical-grid [(widgetId)]="gridID2" [(options)]="opts2"></ig-hierarchical-grid></div>';
            TestBed.overrideComponent(TestComponent, {
                set: {
                    template: template
                }
...
class TestComponent {
    ...
    @ViewChild(Infragistics.IgHierarchicalGridComponent, {static: false}) public viewChild: Infragistics.IgHierarchicalGridComponent;
