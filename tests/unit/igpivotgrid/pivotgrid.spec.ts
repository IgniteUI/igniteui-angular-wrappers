...
export function main() {
    describe('Infragistics Angular2 PivotGrid', () => {
		it('should initialize correctly', injectAsync([TestComponentBuilder, AsyncTestCompleter], (tcb: TestComponentBuilder, async) => {
           var template = '<div><ig-pivot-grid [(widgetId)]="gridId" [options]="optsGrid"></ig-pivot-grid></div>';
...
@Component({
    ...
    directives: [Infragistics.IgPivotGridComponent, Infragistics.IgPivotDataSelectorComponent]
})
class TestComponent {
